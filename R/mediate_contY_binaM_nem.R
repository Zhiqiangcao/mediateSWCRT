...
#' set.seed(123456)
#' mydata1 = gen_data_nem(I,J,n,beta,gamma,theta=0.75,beta_M=1.2,eta=0.6,sigma_a,
...
#' res1 = mediate_contY_binaM_nem(data=mydata1)
#' print(res1)
#' 
...
#' res2 = mediate_contY_binaM_nem(data = mydata2, covariateY = c("X1"), 
#' covariateM = c("X2"))
#' print(res2)
#' 
#' # example 3: mediation analysis with the same covariates in outcome and mediator models
#' res3 = mediate_contY_binaM_nem(data = mydata2, 
...
#' set.seed(123456)
#' mydata3 = gen_data_nem(I,J,n,beta,gamma,theta=0.75,beta_M=1,eta=0.8,sigma_a,
#' sigma_phi,sigma_ey,sigma_tau,sigma_psi,sigma_em,binary.o=0,binary.m=1)
#' res4 = mediate_contY_binaM_nem(data=mydata3)
#' print(res4)
#' 


mediate_contY_binaM_nem = function(data, outcome = "Y", mediator = "M", treatment = "A", cluster = "cluster", 
  ...
  for(j in 1:J){
    ...
    niej = Kappa_STA(gammaj=gammaj,eta=eta_hat,gammax=gamma_x,sigma_tau=sigmatau,sigma_psi=sigmapsi)
  ...
  for(g in 1:ng){
    ...
    for(j in 1:J){
      ...
      niej_g = Kappa_STA(gammaj=gammaj_g,eta=eta_hat_g,gammax = gamma_x_g, 
