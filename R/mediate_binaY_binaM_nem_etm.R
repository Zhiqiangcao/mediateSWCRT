...
mediate_binaY_binaM_nem_etm = function(data, outcome = "Y", mediator = "M", treatment = "A", cluster = "cluster", 
  ...
  ##compute double integral \lambda (double STA method)
  ...
  for(e in 1:(El-1)){
    ...
    for(j in 1:(J-e-dje)){
      ...
      nie_je[j] = log(P111/(1-P111))-log(P110/(1-P110))
      nde_je[j] = log(P110/(1-P110))-log(P010/(1-P010))
    }
  ...
  for(g in 1:ng){
    ...
    for(e in 1:(El-1)){
      ...
      for(j in 1:(J-e-dje)){
        ...
        nie_je_g[j] = log(P111_g/(1-P111_g))-log(P110_g/(1-P110_g))
        nde_je_g[j] = log(P110_g/(1-P110_g))-log(P010_g/(1-P010_g))
      }
